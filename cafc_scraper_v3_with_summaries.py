#!/usr/bin/env python3
"""
CAFC Daily Decisions Email Generator v3
Now with AI-generated summaries using Claude API
"""
...
def main():
    ...
    print("CAFC Daily Decisions Email Generator v3 (with AI Summaries)")
    print("=" * 60)
    ...
    try:
        ...
        summarizer = DecisionSummarizer(api_key) if api_key else None
        
        # Scrape decisions
        scraper = CAFCScraper(summarizer)
        print("\nFetching recent decisions from CAFC RSS feed...")
        decisions = scraper.fetch_recent_decisions(
            days_back=30,
            summarize_all=True  # Generate summaries for all decisions issued today
        )
